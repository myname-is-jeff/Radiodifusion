...
class CODEC_ESTEREO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "CODEC_ESTEREO")
...
def main(top_block_cls=CODEC_ESTEREO, options=None):
