...
class FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frec_range = qtgui.Range(0, 15e3, 100, 50, 200)
        ...
        self._amp_range = qtgui.Range(0, 1, .1, 1, 200)
        ...
        labels = ['Gen', 'Quad', 'Block', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frec, amp, 0, 0)
        ...
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.blocks_delay_0, 0))
        ...
        self.connect((self.blocks_complex_to_arg_0, 0), (self.qtgui_time_sink_x_1, 2))
    ...
    def set_deltaF(self, deltaF):
        self.deltaF = deltaF
        self.set_bw(2*(self.deltaF+15e3))
