...
class MPX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "MPX")
        ...
        self.connect((self.blocks_complex_to_imag_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_complex_to_imag_1, 0), (self.qtgui_time_sink_x_0, 1))
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_complex_to_real_1, 0))
