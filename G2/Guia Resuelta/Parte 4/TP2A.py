...
class TP2A(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "TP2A")
        ...
        self.qtgui_number_sink_0_0.set_title("Pico")
        ...
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_float*1, 2500)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff((samp_rate/(2*np.pi)))
        self.blocks_moving_average_xx_0 = blocks.moving_average_ff(2500, (1/2500), 4000, 1)
        self.blocks_max_xx_0 = blocks.max_ff(2500, 1)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\Bauti\\Desktop\\Facu\\Radiodifusion\\Radiodifusion\\G2\\Guia Resuelta\\Parte 4\\signal_2_5e+06_2.bin', True, 0, 0)
        ...
        self.connect((self.blocks_max_xx_0, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.blocks_moving_average_xx_0, 0), (self.blocks_transcendental_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.blocks_moving_average_xx_0, 0))
        ...
        self.connect((self.blocks_transcendental_0, 0), (self.qtgui_number_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_multiply_const_vxx_0.set_k((self.samp_rate/(2*np.pi)))
