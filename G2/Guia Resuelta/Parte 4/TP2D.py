...
class TP2D(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "TP2D")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\Bauti\\Desktop\\Facu\\Radiodifusion\\Radiodifusion\\G2\\Guia Resuelta\\Parte 4\\radio_240k.dat', True, 0, 0)
        ...
        self.band_pass_filter_0_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.analog_quadrature_demod_cf_0 = analog.quadrature_demod_cf((samp_rate/(2*math.pi*deltaF)))
        ...
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.band_pass_filter_0_0_0, 0))
        ...
        self.connect((self.band_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_1, 1))
        self.connect((self.band_pass_filter_0_0_0, 0), (self.blocks_multiply_xx_0_0, 1))
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_freq_sink_x_1, 2))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_freq_sink_x_1_0, 1))
        ...
        self.connect((self.low_pass_filter_1, 0), (self.qtgui_freq_sink_x_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_quadrature_demod_cf_0.set_gain((self.samp_rate/(2*math.pi*self.deltaF)))
        self.band_pass_filter_0_0.set_taps(firdes.band_pass(1, self.samp_rate, 18000, 20000, 1000, window.WIN_HAMMING, 6.76))
        self.band_pass_filter_0_0_0.set_taps(firdes.band_pass(1, self.samp_rate, 23000, 53000, 1000, window.WIN_HAMMING, 6.76))
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 18000, 1000, window.WIN_HAMMING, 6.76))
