...
class TPAMa(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_fff(1, variable_low_pass_filter_taps_1)
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_peak_detector2_fb_0 = blocks.peak_detector2_fb(0.5, 5, 0.001)
        ...
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 1000, 1, 0, 0)
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_multiply_xx_1, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.blocks_peak_detector2_fb_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.blocks_peak_detector2_fb_0, 0), (self.blocks_char_to_float_0_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.fir_filter_xxx_0, 0), (self.qtgui_time_sink_x_0_0, 2))
    ...
    def set_variable_low_pass_filter_taps_1(self, variable_low_pass_filter_taps_1):
        ...
        self.fir_filter_xxx_0.set_taps(self.variable_low_pass_filter_taps_1)
