...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\Bauti\\Desktop\\Facu\\Radiodifusion\\Radiodifusion\\G2\\Guia Resuelta\\espectro_2M.dat', True, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(95.1e6, self.samp_rate)
