...
class TPAMa(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, ((2*np.pi*deltaF)), 1)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_integrate_xx_0 = blocks.integrate_ff(1, 1)
        self.blocks_complex_to_float_0 = blocks.complex_to_float(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 37500, 1, 0, 0)
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_time_sink_x_0_0, 1))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_integrate_xx_0, 0))
